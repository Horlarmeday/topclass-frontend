<!-- =========================================================================================
  ...
  Description: Label List - List View
========================================================================================== -->

<template>
  <div id="data-list-list-view" class="data-list-container">
    <vs-table :sst="true" @search="handleSearch" ref="table" v-model="selected" :max-items="itemsPerPage" search :data="labels" :total="queriedItems">
      ...
      <div slot="header" class="flex flex-wrap-reverse items-center flex-grow justify-between">
        ...
        <div class="flex flex-wrap-reverse items-center data-list-btn-container">
          ...
          <div class="btn-add-new p-3 mb-4 mr-4 rounded-lg cursor-pointer flex items-center justify-center text-lg font-medium text-base text-primary border border-solid border-primary" @click="showDisplayPrompt">
              ...
              <span class="ml-2 text-base text-primary">Add Label</span>
          </div>
      ...
      <add-new-label :displayPrompt="displayPrompt" @hideDisplayPrompt="hidePrompt" v-if="displayPrompt"></add-new-label>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    queriedItems () {
      return this.$store.state.utilities.labelTotal
    },
    pages() {
      return this.$store.state.utilities.labelPages
    }
  },
  methods: {
    handleError(error) {
    ...
    handleSearch(search) {
      this.currentPage = 1
      this.$store.dispatch('utilities/fetchLabels', { currentPage: this.currentPage, itemsPerPage: this.itemsPerPage, search })
    },

    handlePageChange() {
      this.$store.dispatch('utilities/fetchLabels', { currentPage: this.currentPage, itemsPerPage: this.itemsPerPage })
    },
  },
  created () {
    this.$store.dispatch('utilities/fetchLabels', { currentPage: this.currentPage, itemsPerPage: this.itemsPerPage })
