        ...
        <template slot-scope="{data}">
          <tbody>
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
              ...
              <vs-td>
                <vs-chip :color="getOrderStatusColor(tr.is_approved)" class="product-order-status">Approved</vs-chip>
              </vs-td>
  ...
  methods: {
    ...
    openConfirm(ivid) {
      ...
      this.$vs.dialog({
        ...
        color: 'success',
        title: `Confirm`,
        text: 'Are you sure, you want to stepdown this invoice?.',
        accept: this.stepDown
      })
    },
