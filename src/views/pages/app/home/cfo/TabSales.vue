...
<template>
  <div id="data-list-list-view" class="data-list-container">
          ...
          <tbody>
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
              ...
              <vs-td class="whitespace-no-wrap">
                ...
                <feather-icon icon="PlusIcon" svgClasses="w-5 h-5 hover:text-danger stroke-current" class="ml-2" @click="addPayment(tr)" />
              </vs-td>
            </vs-tr>
          </tbody>
        </template>
    ...
    <add-payment :paymentPrompt="paymentPrompt" :data="saleToEdit" @hidePaymentPrompt="hidePaymentPrompt" v-if="paymentPrompt"></add-payment>
  </div>
</template>

<script>
import AddPayment from'../accountant/AddPayment'
export default {
  components: {
    AddPayment
  },
