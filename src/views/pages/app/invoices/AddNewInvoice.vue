                ...
                <div class="flex">
                    ...
                    <div class="vx-col w-3/5">
                        ...
                        <div v-if="checkProduct === 'products'" class="mb-6">
                            ...
                            <div class="vx-row mb-3" v-for="(prod, index) in productItems" :key="index">
                                    <div class="w-1/3 mr-2">
                                        <v-select
                        ...
                        <div v-if="checkProduct === 'services'" class="mb-6">
                            <div class="mb-4 ml-2"><vs-button size="small" @click="addNewService">New</vs-button></div>
                            <div class="vx-row mb-3" v-for="(serv, index) in serviceItems" :key="index">
                                ...
                                <feather-icon icon="TrashIcon" class="ml-3" v-if="index !== 0" svgClasses="w-5 h-5 hover:text-danger text-danger stroke-current" @click="clearService(index)" />
